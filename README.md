...
This assignment focuses on strengthening fundamental TypeScript concepts, including type safety, functions, generics, interfaces, class inheritance, and array manipulation. All solutions are implemented in a single file: **`solutions.ts`**.
